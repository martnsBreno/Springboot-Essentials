...
class AnimeControllerIT {
    ...
    @Autowired
    private AnimeAPIUserRepository devDojoUserRepository;
    private static final AnimesAPIUser USER = AnimesAPIUser.builder()
    ...
    private static final AnimesAPIUser ADMIN = AnimesAPIUser.builder()
            .name("William Suane")
            .password("{bcrypt}$2a$10$hSTIR1LEGbkA6US1B0IJVeoTsHrFKzPwXSeE40SvIFckopmMHoUTm")
            .username("william")
    ...
    void delete_RemovesAnime_WhenSuccessful() {
        ...
        ResponseEntity<Void> animeResponseEntity = testRestTemplateRoleAdmin.exchange("/animes/{id}",
